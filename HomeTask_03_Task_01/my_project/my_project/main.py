...
#retrieving all cat's info from the data base
...
#getting info using a cat's name 
...
# renewing age by the cat's name
...
#add new characteristic to the feature list
...
#deletion documents by the name of a cat
...
if __name__ == "__main__":
    ...
    #calling delete_cat_document function to delete document by cat's name 
